...
<body>
	<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table"
		action="cgformTemplateController.do?doUpdate">
		...
		<div style="float: right; height: 99%; width: 70%">
			<table style="width: 100%; height: 100%" cellpadding="0" cellspacing="1" class="formtable">
				...
				<tr>
					...
					<td class="value"><input disabled id="templateCode" name="templateCode" type="text" style="width: 300px"
						class="inputxt" datatype="/\w{1,20}/i" errormsg="编码只能为字母！" value='${cgformTemplatePage.templateCode}'> <span
				...
				<tr>
					...
					<td class="value"><input id="templateName" name="templateName" type="text" style="width: 300px"
						class="inputxt" datatype="*" value='${cgformTemplatePage.templateName}' /> <span class="Validform_checktip"></span>
						<label class="Validform_label" style="display: none;">表单风格名称</label></td>
				</tr>
				<tr>
			  ...
			  <tr>
				...
				<tr>
					...
					<td class="value"><span id="templatePicspan">
						...
						</span> <input type="hidden" id="templatePic" name="templatePic" value="${cgformTemplatePage.templatePic}" />
						<div class="form" id="picDiv"></div> <span class="Validform_checktip"></span> <label class="Validform_label"
							style="display: none;">预览图</label></td>
				</tr>

				<tr>
					<td align="right"><label class="Validform_label"> 上传风格模板: </label></td>
					<td class="value"><t:upload id="templateZip" buttonText="浏览文件" multi="false" name="templateZip"
						...
						<div class="form" id="filediv"></div> <span class="Validform_checktip"></span> <label class="Validform_label"
							style="display: none;">表单风格模板</label> <input type="hidden" id="templateZipName" name="templateZipName" /></td>
				...
				<tr>
					...
					<td class="value"><textarea style="width: 400px; height: 60px" class="inputxt" rows="6" id="templateComment"
							name="templateComment">${cgformTemplatePage.templateComment}</textarea> <span class="Validform_checktip"></span>
						<label class="Validform_label" style="display: none;">表单风格描述</label></td>
				</tr>
				<%-- <tr>
				  <td align="right">
