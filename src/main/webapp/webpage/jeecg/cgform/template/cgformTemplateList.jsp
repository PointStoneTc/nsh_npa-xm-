...
<div class="easyui-layout" fit="true">
	<div region="center" style="padding: 0px; border: 0px">
		<t:datagrid name="cgformTemplateList" checkbox="true" fitColumns="true" title="Online表单风格列表"
			...
			<t:dgCol title="是否共享" hidden="true" field="templateShare" query="false" queryMode="single" dictionary="sf_yn"
				width="120"></t:dgCol>
			...
			<t:dgToolBar title="录入" icon="icon-add" url="cgformTemplateController.do?goAdd" funname="add" width="900"
				height="500"></t:dgToolBar>
			<t:dgToolBar title="编辑" icon="icon-edit" url="cgformTemplateController.do?goUpdate" funname="update" width="900"
				height="500"></t:dgToolBar>
			<t:dgToolBar title="批量删除" icon="icon-remove" url="cgformTemplateController.do?doBatchDel" funname="deleteALLSelect"></t:dgToolBar>
			<t:dgToolBar title="查看" icon="icon-search" url="cgformTemplateController.do?goUpdate" funname="detail" width="900"
				height="500"></t:dgToolBar>
			<%-- 
