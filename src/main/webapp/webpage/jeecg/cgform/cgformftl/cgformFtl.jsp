...
<body style="overflow-y: hidden" scroll="no">
	<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="div" beforeSubmit="upload">
		...
		<fieldset class="step">
			...
			<div class="form">
				<t:upload name="fiels" buttonText="选择Word模板文件" width="120" uploader="cgformFtlController.do?saveWordFiles"
					extend="*.doc" id="file_upload" formData="id,cgformId,cgformName,ftlVersion,ftlStatus"></t:upload>
			</div>
