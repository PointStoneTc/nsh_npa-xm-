...
<div class="easyui-layout" fit="true">
	<div region="center" style="padding: 0px; border: 0px">
		<t:datagrid name="cgformFtlList" title="表单模板列表" actionUrl="cgformFtlController.do?datagrid&cgformId=${formid}"
			idField="id" fit="true">
			...
			<t:dgConfOpt title="激活" url="cgformFtlController.do?active&id={id}&formId=${formid}" urlclass="ace_button"
				urlfont="fa-toggle-on" message="确认激活模板" exp="ftlStatus#eq#0" />
			<t:dgConfOpt title="取消激活" url="cgformFtlController.do?cancleActive&id={id}&formId=${formid}" urlclass="ace_button"
				urlfont="fa-toggle-off" message="确认取消激活" exp="ftlStatus#eq#1" />
			...
			<t:dgToolBar title="创建模板" icon="icon-add" funname="add" width="100%"
				url="cgformFtlController.do?addorupdate&cgformId=${formid}" height="100%"></t:dgToolBar>
			<%-- 
	...
	--%>
			<t:dgToolBar title="模板编辑" icon="icon-edit" funname="update"
				url="cgformFtlController.do?addorupdate&cgformId=${formid}" width="100%" height="100%"></t:dgToolBar>
