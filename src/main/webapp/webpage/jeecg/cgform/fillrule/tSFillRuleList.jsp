...
<div class="easyui-layout" fit="true">
	<div region="center" style="padding: 0px; border: 0px">
		<t:datagrid name="tSFillRuleList" checkbox="false" pagination="true" fitColumns="true" title="填值规则表"
			actionUrl="tSFillRuleController.do?datagrid" idField="id" fit="true" queryMode="group">
