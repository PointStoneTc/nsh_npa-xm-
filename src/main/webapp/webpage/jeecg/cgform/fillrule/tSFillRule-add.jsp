...
<body>
	<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="tSFillRuleController.do?doAdd"
		tiptype="1">
			...
			<div class="con-wrapper" id="con-wrapper1" style="display: block;">
				<div class="row form-wrapper">
					...
					<div class="row show-grid">
						...
						<div class="col-xs-3">
							<input id="ruleClass" name="ruleClass" type="text" style="width: 380px" class="form-control" ignore="ignore" />
							<span class="Validform_checktip" style="float: left; height: 0px;"></span>
