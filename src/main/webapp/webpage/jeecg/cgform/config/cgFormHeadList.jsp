...
<div class="easyui-layout" fit="true">
	...
	<div region="center" style="padding: 0px; border: 0px">
		<t:datagrid sortName="createDate" sortOrder="desc"
			...
			<t:dgFunOpt funname="remCgForm(id)" title="common.remove"
				inGroup="true" urlclass="ace_button"
	...
	--%>
			<t:dgFunOpt exp="isDbSynch#eq#N" inGroup="true" title="sync.db"
				funname="doDbsynch(id,content)" urlclass="ace_button"
				urlfont="fa-database" />
			<t:dgFunOpt exp="isDbSynch#eq#Y&&jformType#ne#3" inGroup="true"
			...
			<t:dgFunOpt exp="isDbSynch#eq#Y&&jformType#ne#3"
				...
				urlStyle="background-color:#293846;" urlclass="ace_button"
			...
			<t:dgFunOpt funname="copyOnline(id)" title="复制表单" inGroup="true"
			...
			<t:dgFunOpt exp="hasPeizhi#ne#0" funname="propertyTable(id)"
				inGroup="true" title="配置表" urlclass="ace_button" urlfont="fa-cog"></t:dgFunOpt>
