...
<body style="overflow-y: hidden" scroll="no">
	<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table"
		action="cgformEnhanceJsController.do?save">
		...
		<table cellpadding="0" cellspacing="1" class="formtable">
			<tr>
				<td align="right"><label class="Validform_label">
						<t:mutiLang langKey="enhance.type" />
						:
					</label></td>
			...
			<tr>
				<td align="right"><label class="Validform_label">
						<t:mutiLang langKey="enhance.js" />
						:
					</label></td>
				<td class="value"><textarea id="cgJsStr" name="cgJsStr" cols="130" rows="30">${cgformenhanceJsPage.cgJsStr}</textarea>
