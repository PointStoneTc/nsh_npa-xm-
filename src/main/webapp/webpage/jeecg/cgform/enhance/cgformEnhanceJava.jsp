...
<body style="overflow-y: hidden" scroll="no">
	<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table"
		action="cgformEnhanceJavaController.do?save">
		...
		<table cellpadding="0" cellspacing="1" class="formtable">
			...
			<tr>
				...
				<td class="value"><t:dictSelect field="cgJavaType" type="radio" typeGroupCode="enhanceType" hasLabel="false"
						defaultVal="${cgformEnhanceJavaPage.cgJavaType==null?'spring':(cgformEnhanceJavaPage.cgJavaType)}"></t:dictSelect>
			...
			<tr>
				...
				<td class="value"><input id="cgJavaValue" name="cgJavaValue" type="text" style="width: 300px; height: 26px"
					value="${cgformEnhanceJavaPage.cgJavaValue}" />
				<span class="Validform_checktip"></span></td>
				<!--update-end--Author:luobaoli  Date:20150701 for：取消非空校验-->
			</tr>
			<tr>
				...
				<td class="value"><input type="radio" name="activeStatus" value="0"
					${cgformEnhanceJavaPage.activeStatus eq 0 ? 'checked' : '' } /> <t:mutiLang langKey="common.disable" /> <input
					type="radio" name="activeStatus" value="1"
					${empty cgformEnhanceJavaPage.activeStatus or cgformEnhanceJavaPage.activeStatus eq '1' ? 'checked' : '' } /> <t:mutiLang
						langKey="common.enable" /> <span class="Validform_checktip"></span></td>
			</tr>
		</table>
	</t:formvalid>
</body>
