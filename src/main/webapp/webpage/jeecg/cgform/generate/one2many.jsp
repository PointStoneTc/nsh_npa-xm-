	...
	<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1"
		...
		<table cellpadding="0" cellspacing="1" class="formtable">
			<tr>
				...
				<td class="value"><input type="text" class="inputxt" name="projectPath" value="${projectPath }"
			...
			<tr>
				...
				<td class="value"><input class="inputxt" id="entityName" name="entityName" datatype="*"
					value="${entityNames[cgFormHeadPage.tableName]}"> <span class="Validform_checktip"></span></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="value"><input class="inputxt" id="entityPackage" name="entityPackage" datatype="*"> <span
						class="Validform_checktip"></span></td>
			</tr>
			<tr>
				<td align="right"><label class="Validform_label"> 模板类型: </label></td>
				<td class="value" colspan="3"><input type="radio" name="version" datatype="*" value="ext">老版本模板(IE8+/不支持移动/标签列表)
			...
			<tr>
				...
				<td class="value" colspan="3"><input type="radio" name="supportRestful" value="1" />是 <input type="radio"
					name="supportRestful" checked="checked" value="0" />否</td>
			</tr>
			<tr>
				<td align="right"><label class="Validform_label"> 页面风格: </label></td>
				<td class="value"><select id="jspMode" name="jspMode" style="width: 300px" datatype="*">
		...
		<table cellpadding="0" cellspacing="1" class="formtable">
			<c:forEach items="${subTableList}" var="column" varStatus="columIndex">
				<tr>
					...
					<td class="value" colspan="3"><input readonly="readonly" class="inputxt"
						id="subTabParamIn[${columIndex.index}].tableName" name="subTabParamIn[${columIndex.index}].tableName"
						value="${column.tableName}" datatype="*"> <span class="Validform_checktip"></span></td>

					<td align="right">子表实体(首字母大写):</td>
					<td class="value" colspan="3"><input class="inputxt" id="subTabParamIn[${columIndex.index}].entityName"
						name="subTabParamIn[${columIndex.index}].entityName" value="${entityNames[column.tableName]}" datatype="*">
						<span class="Validform_checktip"></span></td>

					<td align="right">功能说明:</td>
					<td class="value" colspan="3"><input class="inputxt" id="subTabParamIn[${columIndex.index}].ftlDescription"
						name="subTabParamIn[${columIndex.index}].ftlDescription" datatype="*"> <span class="Validform_checktip"></span></td>

					<td align="right">子包名(小写):</td>
					<td class="value" colspan="3"><input class="inputxt" id="subTabParamIn[${columIndex.index}].entityPackage"
						name="subTabParamIn[${columIndex.index}].entityPackage" datatype="*"> <span class="Validform_checktip"></span></td>
