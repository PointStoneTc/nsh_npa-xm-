	...
	<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1"
		...
		<table cellpadding="0" cellspacing="1" class="formtable">
			...
			<tr>
				...
				<td class="value" colspan="5"><textarea rows="5" cols="150" id="cgrSql" name="cgrSql" datatype="*"></textarea>
					...
					<p>
						&nbsp;&nbsp;&nbsp;&nbsp;您可以键入“${abc}”作为一个参数，这里abc是参数的名称。例如：<br /> &nbsp;&nbsp;&nbsp;&nbsp;select * from table
						where id =
						<%="${abc}"%>。<br /> &nbsp;&nbsp;&nbsp;&nbsp;select * from table where id like concat('%',<%="${abc}"%>,'%')。(mysql模糊查询)<br />
			...
			<tr>
				<td align="right"><label class="Validform_label">
						<t:mutiLang langKey="common.returnvalfield" />
						:
					</label></td>
				...
				<td align="right"><label class="Validform_label">
						<t:mutiLang langKey="common.returntxtfield" />
						:
					</label></td>
				<td class="value"><input id="returnTxtField" name="returnTxtField" type="text" style="width: 150px"
					class="inputxt"> <span class="Validform_checktip"></span></td>
				<td align="right"><label class="Validform_label">
						<t:mutiLang langKey="common.returntxttype" />
						:
					</label></td>
				<td class="value" colspan="2"><t:dictSelect field="popRetype" typeGroupCode="pop_retype" hasLabel="false"
						defaultVal="1" />
					<span class="Validform_checktip"></span></td>
			</tr>
		...
		<div style="width: auto;">
			...
			<t:tabs id="ttp" iframe="false" tabPosition="top" fit="false">
				<t:tab href="cgreportConfigHeadController.do?cgreportConfigParamList&id=${cgreportConfigHeadPage.id}"
					icon="icon-search" title="报表参数" id="cgreportConfigParam"></t:tab>
			</t:tabs>
			<t:tabs id="tt" iframe="false" tabPosition="top" fit="false">
				<t:tab href="cgreportConfigHeadController.do?cgreportConfigItemList&id=${cgreportConfigHeadPage.id}"
					icon="icon-search" title="dynamic.report.config.detail" id="cgreportConfigItem"></t:tab>
			</t:tabs>
		</div>
	</t:formvalid>
	<!-- 添加 附表明细 模版 -->
		...
		<tbody id="add_cgreportConfigItem_table_template">
			<tr>
				...
				<td align="left"><input name="cgreportConfigItemList[#index#].fieldTxt" maxlength="1000" type="text"
					class="inputxt" style="width: 120px;"></td>
				<td align="left"><t:dictSelect field="cgreportConfigItemList[#index#].fieldType"
				...
				<td align="left"><t:dictSelect field="cgreportConfigItemList[#index#].SMode" extendJson="{style:'width:90px'}"
						type="list" typeGroupCode="searchmode" defaultVal="" hasLabel="false" title="common.query.module"></t:dictSelect></td>
				...
				<td align="left"><input name="cgreportConfigItemList[#index#].dictCode" maxlength="36" type="text"
					class="inputxt" style="width: 120px;"></td>
				<td align="left"><t:dictSelect field="cgreportConfigItemList[#index#].SFlag" extendJson="{style:'width:90px'}"
						type="list" typeGroupCode="yesorno" defaultVal="" hasLabel="false" title="common.isquery"></t:dictSelect></td>
			</tr>
		</tbody>
	</table>
	<table style="display: none">
