			...
			<c:if test="${fn:length(cgreportConfigParamList)  > 0 }">
				<c:forEach items="${cgreportConfigParamList}" var="poVal" varStatus="stuts">
					<tr>
						...
						<td align="left"><input name="cgreportConfigParamList[${stuts.index }].paramName" value="${poVal.paramName }"
							maxlength="32" type="text" class="inputxt" style="width: 120px;"></td>
						<td align="left"><input name="cgreportConfigParamList[${stuts.index }].paramDesc" value="${poVal.paramDesc }"
							maxlength="32" type="text" class="inputxt" style="width: 120px;"></td>
						<td align="left"><input name="cgreportConfigParamList[${stuts.index }].paramValue"
							value="${poVal.paramValue }" maxlength="32" type="text" class="inputxt" style="width: 120px;"></td>
						<td align="left"><input name="cgreportConfigParamList[${stuts.index }].seq" value="${poVal.seq }"
							maxlength="32" type="text" class="inputxt" style="width: 120px;"></td>
					</tr>
				</c:forEach>
			</c:if>
