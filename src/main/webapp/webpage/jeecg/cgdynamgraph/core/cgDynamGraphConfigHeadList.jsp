...
<div class="easyui-layout" fit="true">
	<div region="center" style="padding: 0px; border: 0px">
		<t:datagrid fitColumns="true" checkbox="true" name="cgDynamGraphConfigHeadList" title="在线移动图表"
			...
			<t:dgDelOpt title="common.delete" url="cgDynamGraphConfigHeadController.do?doDel&id={id}" urlclass="ace_button"
				urlfont="fa-trash-o" />
			...
			<t:dgToolBar title="common.add" icon="icon-add" url="cgDynamGraphConfigHeadController.do?goAdd" funname="add"
				height="450" width="1200"></t:dgToolBar>
			<t:dgToolBar title="common.edit" icon="icon-edit" url="cgDynamGraphConfigHeadController.do?goUpdate" funname="update"
				height="450" width="1200"></t:dgToolBar>
			<t:dgToolBar title="common.batch.delete" icon="icon-remove" url="cgDynamGraphConfigHeadController.do?doBatchDel"
				funname="deleteALLSelect"></t:dgToolBar>
			<t:dgToolBar title="common.view" icon="icon-search" url="cgDynamGraphConfigHeadController.do?goUpdate"
				funname="detail" height="450" width="1200"></t:dgToolBar>
		</t:datagrid>
	</div>
</div>
