...
<div style="padding: 3px; height: 25px; width: auto;" class="datagrid-toolbar">
	<a id="addCgreportConfigParamBtn" href="javascript:void(0);">添加</a> <a id="delCgreportConfigParamBtn"
...
<div style="width: auto; height: 150px; overflow-y: auto; overflow-x: scroll;">
	<table border="0" cellpadding="2" cellspacing="0" id="cgreportConfigParam_table">
		<tr bgcolor="#E6E6E6">
			...
			<td align="left" bgcolor="#EEEEEE" style="width: 120px;"><label class="Validform_label">
			...
			<c:if test="${fn:length(cgDynamGraphConfigParamList)  > 0 }">
				<c:forEach items="${cgDynamGraphConfigParamList}" var="poVal" varStatus="stuts">
					<tr>
						...
						<td align="left"><input name="cgDynamGraphConfigParamList[${stuts.index }].paramName"
							value="${poVal.paramName }" maxlength="32" type="text" class="inputxt" style="width: 120px;"></td>
						<td align="left"><input name="cgDynamGraphConfigParamList[${stuts.index }].paramDesc"
							value="${poVal.paramDesc }" maxlength="32" type="text" class="inputxt" style="width: 120px;"></td>
						<td align="left"><input name="cgDynamGraphConfigParamList[${stuts.index }].paramValue"
							value="${poVal.paramValue }" maxlength="32" type="text" class="inputxt" style="width: 120px;"></td>
						<td align="left"><input name="cgDynamGraphConfigParamList[${stuts.index }].seq" value="${poVal.seq }"
