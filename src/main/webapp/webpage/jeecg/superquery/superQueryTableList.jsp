	...
	<tbody id="add_superQueryTable_table">
		<c:if test="${fn:length(superQueryTableList)  <= 0 }">
			<tr data-index="0">
				...
				<td align="left"><input name="superQueryTableList[0].seq" maxlength="32" type="text" class="inputxt"
					datatype="*" style="width: 60px;"> <label class="Validform_label" style="display: none;">序号</label></td>
				<td align="left"><input onchange="myFunction()" name="superQueryTableList[0].tableName" maxlength="32"
					type="text" class="inputxt tableList" style="width: 180px;" datatype="*"> <label class="Validform_label"
						style="display: none;">表名</label></td>
				<td align="left"><input name="superQueryTableList[0].instruction" maxlength="32" type="text" class="inputxt"
					style="width: 120px;" datatype="*"> <label class="Validform_label" style="display: none;">说明</label></td>
				<td align="left">
					<%-- <t:dictSelect   field="superQueryTableList[0].isMain" type="radio"   typeGroupCode="is_main"  defaultVal="${superQueryTablePage.isMain}" hasLabel="false"  title="是否是主表" >
							</t:dictSelect>  --%> 是 <input class="ismain" name="superQueryTableList[0].isMain" type="radio" value="Y"
					datatype="*" checked="checked" readonly="readonly" />&nbsp; 否<input class="ismain"
					name="superQueryTableList[0].isMain" type="radio" value="N" disabled="disabled" /> <label class="Validform_label"
						style="display: none;">是否是主表</label>
				</td>
				<td align="left"><input name="superQueryTableList[0].fkField" maxlength="32" type="text" class="inputxt"
					style="width: 120px;"> <label class="Validform_label" style="display: none;">外键字段</label></td>
			</tr>
		</c:if>
		<c:if test="${fn:length(superQueryTableList)  > 0 }">
			<c:forEach items="${superQueryTableList}" var="poVal" varStatus="stuts">
				<tr data-index="${stuts.index }">
					...
					<td align="left"><input name="superQueryTableList[${stuts.index }].seq" maxlength="32" type="text"
						class="inputxt" style="width: 60px;" ignore="ignore" value="${poVal.seq }" /> <label class="Validform_label"
							style="display: none;">序号</label></td>
					<td align="left"><input onchange="myUpdateFunction()" name="superQueryTableList[${stuts.index }].tableName"
						maxlength="32" type="text" class="inputxt tableList" style="width: 180px;" ignore="ignore"
						value="${poVal.tableName }" /> <label class="Validform_label" style="display: none;">表名</label></td>
					<td align="left"><input name="superQueryTableList[${stuts.index }].instruction" maxlength="32" type="text"
						class="inputxt " style="width: 120px;" value="${poVal.instruction }" /> <label class="Validform_label"
					...
					<td align="left">
						...
						<c:set var="ismain" value="${poVal.isMain}"></c:set> <c:choose>
							...
							否<input class="ismain" name="superQueryTableList[${stuts.index}].isMain" type="radio" value="N"
									disabled="disabled" />
							...
							是 <input class="ismain" name="superQueryTableList[${stuts.index}].isMain" type="radio" value="Y"  />&nbsp;
							否<input class="ismain" name="superQueryTableList[${stuts.index}].isMain" type="radio" value="N" checked="checked" />
							</c:if> --%> <label class="Validform_label" style="display: none;">是否是主表</label>
					</td>
					<td align="left"><input name="superQueryTableList[${stuts.index }].fkField" maxlength="32" type="text"
						class="inputxt" style="width: 120px;" ignore="ignore" value="${poVal.fkField }" /> <label class="Validform_label"
