...
<div class="easyui-layout" style="width: 800px; height: 400px;">
	...
	<div data-options="region:'center'">
		...
		<t:datagrid checkbox="false" name="userList1" title="common.user.select"
			actionUrl="departAuthGroupController.do?getUserDataGrid&groupId=${groupId}" fit="true" fitColumns="true" idField="id"
			queryMode="group" sortName="createDate" sortOrder="desc" onClick="checkSelect">
