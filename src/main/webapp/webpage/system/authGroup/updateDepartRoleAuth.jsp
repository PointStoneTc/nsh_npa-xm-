		...
		<table class="table-form" cellspacing="0">
			<tbody>
				<tr>
					...
					<td class="ng-binding"><input type="text" name="roleName" id="roleName" value="${role.roleName}" /></td>
				</tr>
				<tr>
					<th style="width: 350px;">
						<span>角色编码:</span>
					</th>
					<td class="ng-binding"><input type="text" name="roleCode" id="roleCode" value="${role.roleCode }" /></td>
				</tr>
			</tbody>
		</table>
	</t:formvalid>
