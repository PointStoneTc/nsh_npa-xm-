...
<div class="easyui-layout" style="width: 700px; height: 400px;">
	...
	<div data-options="region:'center'">
		<t:datagrid pagination="false" name="roleList" title="common.role.select"
			actionUrl="departAuthGroupController.do?datagridRole" idField="id" showRefresh="false" fit="true" queryMode="group"
			onClick="checkSelect">
