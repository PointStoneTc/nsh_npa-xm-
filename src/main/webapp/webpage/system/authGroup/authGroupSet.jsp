		...
		<table class="table-form" cellspacing="0">
			<tbody>
				<tr>
					...
					<td class="ng-binding"><input type="text" name="groupName" id="groupName"
				...
				<tr>
					...
					<td class="ng-binding"><input id="deptId" name="deptId" type="hidden" value="${departAuthGroup.deptId}">
						<input id="deptName" name="deptName" type="text" value="${departAuthGroup.deptName}"
				...
				<tr style="display: none">
					...
					<td class="ng-binding"><input type="hidden" value="${departAuthGroup.departType}" id="departType"
						name="departType"> <input type="text" name="deptCode" id="deptCode" value="${departAuthGroup.deptCode }" /></td>
				</tr>
			</tbody>
		</table>
	</t:formvalid>
