...
<t:datagrid name="userList" title="common.operation" actionUrl="userController.do?interfaceUserDatagrid" fit="true"
	fitColumns="true" idField="id" queryMode="group" sortName="createDate,userName" sortOrder="asc,desc">
	...
	<t:dgDelOpt title="common.delete" url="userController.do?delInterfaceUser&userid={id}" urlclass="ace_button"
		urlfont="fa-trash-o" />
	<t:dgToolBar title="common.add.param" langArg="common.user" icon="icon-add"
		url="userController.do?addorupdateInterfaceUser" funname="add" height="420"></t:dgToolBar>
	<t:dgToolBar title="common.edit.param" langArg="common.user" icon="icon-edit"
		url="userController.do?addorupdateInterfaceUser" funname="update"></t:dgToolBar>
