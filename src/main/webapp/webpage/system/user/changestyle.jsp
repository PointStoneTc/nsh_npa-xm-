...
<body style="overflow-y: hidden" scroll="no">
	<t:formvalid formid="formobj" refresh="false" dialog="true" action="userController.do?savestyle" layout="table">
		<table style="width: 550px" cellpadding="0" cellspacing="1" class="formtable">
			...
			-->
				<tr>
					<td class="value"><input type="radio" value="acele" name="indexStyle" />
			...
			<tr>
			  ...
			  -->
				<tr>
					<td class="value"><input type="radio" value="hplus" name="indexStyle" />
					<span>H+平面风格</span></td>
				</tr>
				<tr>
					<td class="value"><input type="radio" value="fineui" name="indexStyle" />
					<span>FineUI风格</span></td>
				</tr>
			</tbody>
		</table>
	</t:formvalid>
