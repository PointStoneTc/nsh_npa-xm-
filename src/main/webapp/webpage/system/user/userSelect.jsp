...
<div class="easyui-layout" style="width: 1000px; height: 600px;">
	...
	<div data-options="region:'center'">
		<t:datagrid checkbox="true" name="userList1" title="common.user.select"
			actionUrl="userController.do?datagridByOrgCode" fit="true" fitColumns="true" idField="id" queryMode="group"
