...
<div class="easyui-layout" fit="true">
	<div region="center" style="padding: 1px;">
		<t:datagrid name="userList" title="common.user.select" actionUrl="userController.do?datagrid" fitColumns="true"
			idField="id" queryMode="group" checkbox="true" sortName="createDate" sortOrder="desc" onLoadSuccess="initCheck">
