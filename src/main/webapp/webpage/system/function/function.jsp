		...
		<fieldset class="step">
			<div class="form">
				<label class="Validform_label">
					<t:mutiLang langKey="menu.name" />
					:
				</label>
				<input name="functionName" class="inputxt" value="${function.functionName}" datatype="*2-50" />
				<span class="Validform_checktip">
					<t:mutiLang langKey="menuname.rang2to15" />
				</span>
			</div>
			<div class="form">
				<label class="Validform_label">
					<t:mutiLang langKey="funcType" />
					:
				</label>
			...
			<div class="form" id="icon">
				<label class="Validform_label">
					<t:mutiLang langKey="common.icon" />
					:
				</label>
			...
			<div class="form" id="desktopIcon">
				<label class="Validform_label">
					<t:mutiLang langKey="desktop.icon" />
					:
				</label>
			...
			<div class="form" id="funiconstyle">
				...
				<a href="http://fontawesome.dashgame.com" target="_blank"> <i class="fa fa-eye-slash"></i>选择图标库
				</a>
			</div>
		</fieldset>
	</t:formvalid>
