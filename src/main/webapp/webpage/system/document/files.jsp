...
<body style="overflow-y: hidden" scroll="no">
	<t:formvalid formid="formobj" layout="div" dialog="true" beforeSubmit="myBeforeSubmit">
		...
		<fieldset class="step">
			...
			<div class="form">
				<t:upload name="fiels" buttonText="上传文件" uploader="jeecgFormDemoController.do?saveFiles&documentId=${doc.id}"
			...
			<div class="form" id="filediv" style="height: 50px">
				<c:if test="${not empty attachment }">
					<div class="row" style="margin-left: 20px;">${attachment.attachmenttitle }.${attachment.extend }</div>
				</c:if>
			</div>
		</fieldset>
	</t:formvalid>
