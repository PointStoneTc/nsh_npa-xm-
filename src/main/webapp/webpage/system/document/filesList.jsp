...
<div class="easyui-layout" fit="true">
	<div region="center" style="padding: 0px; border: 0px">
		<t:datagrid name="fList" title="文件下载" actionUrl="jeecgFormDemoController.do?documentList&typecode=files" idField="id"
			...
			<t:dgDefOpt url="commonController.do?viewFile&fileid={id}&subclassname={subclassname}" urlclass="ace_button"
				urlfont="fa-trash-o" title="下载"></t:dgDefOpt>
			<t:dgOpenOpt width="700" height="600" url="commonController.do?openViewFile&fileid={id}&subclassname={subclassname}"
				urlclass="ace_button" urlfont="fa-trash-o" title="预览"></t:dgOpenOpt>
			<t:dgDelOpt url="jeecgFormDemoController.do?delDocument&id={id}" title="删除" urlclass="ace_button"
