...
<t:datagrid name="noticeAuthorityUserList" checkbox="true" fitColumns="false" title="common.authority.user"
	actionUrl="noticeAuthorityUserController.do?datagrid&noticeId=${noticeId}" idField="id" fit="true" queryMode="group">
	...
	<t:dgDelOpt title="common.delete" url="noticeAuthorityUserController.do?doDel&id={id}" urlclass="ace_button"
		urlfont="fa-trash-o" />
	<t:dgToolBar title="common.authority.user" icon="icon-add" url="noticeAuthorityUserController.do?doSave"
