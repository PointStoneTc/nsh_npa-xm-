		...
		<fieldset class="step">
			<div class="form">
				<label class="Validform_label">
					<t:mutiLang langKey="operate.name" />
					:
				</label>
			...
			<div class="form">
				<label class="Validform_label">
					<t:mutiLang langKey="operation.type" />
					:
				</label>
			...
			<div class="form">
				<label style="color: red;">
					用法说明：<br> &nbsp;&nbsp;&nbsp;&nbsp;1. 配置隐藏或禁用后，默认所有用户都看不见/禁用;<br> &nbsp;&nbsp;&nbsp;&nbsp;2.
					用户授权后，方可见/可编辑;<br> &nbsp;&nbsp;&nbsp;&nbsp;[ admin 用户有超级权限，不受限制] 
			</div>
			<input name="TSFunction.id" value="${functionId}" type="hidden"> <input name="status" type="hidden" value="0">
			<%-- <div class="form">
