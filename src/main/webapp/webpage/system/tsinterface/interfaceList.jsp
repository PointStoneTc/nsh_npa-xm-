...
<div id="system_function_functionList" class="easyui-layout" fit="true">
	...
	<div region="center" style="padding: 0px; border: 0px">
		<t:datagrid name="interfaceList" title="接口权限管理" actionUrl="interfaceController.do?interfaceGrid" idField="id"
			treegrid="true" pagination="false" btnCls="bootstrap btn btn-normal btn-xs">
			...
			<t:dgCol title="请求方式" field="interfaceMethod" treefield="interfaceMethod" width="100"
			...
			<t:dgDelOpt url="interfaceController.do?del&id={id}" title="common.delete" urlclass="ace_button"
				urlStyle="background-color:#ec4758;" urlfont="fa-trash-o"></t:dgDelOpt>
			<t:dgFunOpt funname="operationData(id)" title="接口权限规则" urlclass="ace_button" urlStyle="background-color:#1a7bb9;"
				urlfont="fa-database"></t:dgFunOpt>
			<t:dgToolBar title="接口权限录入" langArg="common.menu" icon="fa fa-plus" url="interfaceController.do?addorupdate"
				height="400" funname="addFun"></t:dgToolBar>
			<t:dgToolBar title="接口权限编辑" langArg="common.menu" icon="fa fa-edit" url="interfaceController.do?addorupdate"
