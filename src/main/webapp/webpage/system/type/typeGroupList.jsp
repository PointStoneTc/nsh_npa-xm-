...
<div id="main_typegroup_list" class="easyui-layout" fit="true">
	<div region="center" style="padding: 0px; border: 0px">
		<t:datagrid name="typeGridTree" title="common.data.dictionary" actionUrl="systemController.do?typeGroupGrid"
			...
			queryMode="group" btnCls="bootstrap btn btn-info btn-xs">
			...
			<t:dgDelOpt url="systemController.do?delTypeGroup&id={id}" title="common.delete" urlclass="ace_button"
			...
			<t:dgToolBar title="common.add.param" langArg="lang.dictionary.type" icon="fa fa-plus"
			...
			<t:dgToolBar title="common.refreshType" icon="fa fa-refresh" url="systemController.do?refreshTypeGroupAndTypes"
