...
<t:datagrid name="departUserList" title="common.operation"
	...
	<t:dgCol title="common.status" sortable="true" width="300" field="status"
		replace="common.active_1,common.inactive_0,super.admin_-1"></t:dgCol>
	<t:dgCol title="common.operation" field="opt"></t:dgCol>
	<t:dgDelOpt title="common.delete" url="organzationController.do?delUserOrg&userid={id}&departid=${departid }"
	...
	<t:dgToolBar title="common.add.exist.user" icon="icon-add"
		url="organzationController.do?goAddUserToOrg&orgId=${departid}" funname="add" width="650"></t:dgToolBar>
</t:datagrid>
