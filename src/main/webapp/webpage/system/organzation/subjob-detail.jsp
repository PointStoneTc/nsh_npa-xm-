...
<body>
	<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" callback="@Override callbackOrg"
		...
		<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable" disabled="disabled">
			...
			<tr>
				<td align="right" style="width: 30%; height: 30px"><label class="Validform_label"> 岗位名称: </label></td>
			...
			<tr>
				<td align="right" style="height: 30px"><label class="Validform_label"> 岗位描述: </label></td>
