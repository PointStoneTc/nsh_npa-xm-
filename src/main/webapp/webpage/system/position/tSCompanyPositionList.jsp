...
<div class="easyui-layout" fit="true">
	<div region="center" style="padding: 0px; border: 0px">
		<t:datagrid name="tSCompanyPositionList" checkbox="true" pagination="true" fitColumns="true" title="职务管理"
			actionUrl="tSCompanyPositionController.do?datagrid&companyId=${companyId }" idField="id" fit="true" queryMode="group">
			...
			<t:dgToolBar title="录入" icon="icon-add" url="tSCompanyPositionController.do?goAdd&companyId=${companyId }"
				funname="add"></t:dgToolBar>
			<t:dgToolBar title="编辑" icon="icon-edit" url="tSCompanyPositionController.do?goUpdate" funname="update"></t:dgToolBar>
			<t:dgToolBar title="批量删除" icon="icon-remove" url="tSCompanyPositionController.do?doBatchDel"
