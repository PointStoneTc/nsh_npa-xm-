...
<t:datagrid name="operationList" title="operate.manage.data"
	actionUrl="functionController.do?ruledategrid&functionId=${functionId}" idField="id">
	...
	<t:dgDelOpt url="functionController.do?delrule&id={id}" title="common.delete" urlclass="ace_button"
	...
	<t:dgToolBar title="common.add.param" langArg="common.operation" icon="icon-add"
		url="functionController.do?addorupdaterule&functionId=${functionId}" funname="add"></t:dgToolBar>
</t:datagrid>
