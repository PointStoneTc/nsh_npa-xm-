...
<div class="easyui-layout" fit="true">
	<div region="center" style="padding: 0px; border: 0px">
		<t:datagrid name="tSSmsTemplateSqlList" checkbox="true" fitColumns="false" title="common.sqlDataTable"
			actionUrl="tSSmsTemplateSqlController.do?datagrid" idField="id" fit="true" queryMode="group">
			...
			<t:dgCol title="common.msgModeliD" field="templateId" queryMode="single"
				dictionary="t_s_sms_template,id,template_name"></t:dgCol>
			<t:dgCol title="common.createDate" field="createDate" formatter="yyyy-MM-dd" hidden="false" queryMode="group"
				query="true"></t:dgCol>
			<t:dgCol title="common.opt" field="opt" width="150"></t:dgCol>
			<t:dgDelOpt title="common.delete" url="tSSmsTemplateSqlController.do?doDel&id={id}" urlclass="ace_button"
				urlfont="fa-trash-o" />
			...
			<t:dgToolBar title="common.batch.delete" icon="icon-remove" url="tSSmsTemplateSqlController.do?doBatchDel"
