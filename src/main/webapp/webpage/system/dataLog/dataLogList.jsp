...
<div class="easyui-layout" fit="true">
	<div region="center" style="padding: 0px; border: 0px">
		<t:datagrid name="datalogList" checkbox="true" fitColumns="true" title="数据日志"
			actionUrl="systemController.do?datagridDataLog" idField="id" fit="true" queryMode="group">
			<t:dgCol title="主键" field="id" hidden="true" queryMode="single" width="120"></t:dgCol>
			<t:dgCol title="表名" field="tableName" colspan="2" query="true" queryMode="single" width="100"
				extend="{style:{width:'150px'}}"></t:dgCol>
			...
			<t:dgCol title="所属部门" dictionary="t_s_depart,org_code,departname" field="sysOrgCode" hidden="ture" queryMode="single"
				width="120"></t:dgCol>
			<t:dgCol title="所属公司" dictionary="t_s_depart,org_code,departname" field="sysCompanyCode" hidden="false"
