...
<div class="easyui-layout" fit="true">
	<div region="center" style="padding: 0px; border: 0px">
		<t:datagrid name="iconList" title="icon.list" actionUrl="iconController.do?datagrid"
			btnCls="bootstrap btn btn-success btn-xs" fit="true" fitColumns="true" idField="id">
			...
			<t:dgToolBar title="common.add.param" langArg="common.icon" icon="fa fa-plus" url="iconController.do?addorupdate"
				funname="add"></t:dgToolBar>
			<t:dgToolBar title="common.edit.param" langArg="common.icon" icon="fa fa-edit" url="iconController.do?addorupdate"
			...
			<t:dgToolBar title="UI标签链接按钮样式" icon="fa fa-paper-plane" url="webpage/common/functionIconStyleList.jsp?style=urlfont"
				funname="add"></t:dgToolBar>
		</t:datagrid>
	</div>
</div>
