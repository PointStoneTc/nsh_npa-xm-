...
<div id="main_role_list" class="easyui-layout" fit="true">
	<div region="center" style="padding: 0px; border: 0px">
		<t:datagrid name="noCurRoleUserList" title="common.operation"
			actionUrl="interroleController.do?addUserToRoleList&roleId=${param.roleId}" fit="true" fitColumns="true" idField="id"
...
<div style="display: none">
	<t:formvalid formid="formobj" layout="div" dialog="true"
		action="interroleController.do?doAddUserToRole&roleId=${param.roleId}" beforeSubmit="setUserIds">
