...
<script type="text/javascript" src="${webRoot}/static/js/npa/naturalPerson/guarantee_list.js"></script>
<link rel="stylesheet" href="${webRoot}/static/style/css/commcon.css">
</head>
<body>
	<table id="guaranteeList" class="easyui-datagrid" title="担保人列表"
		data-options="rownumbers:true,singleSelect:true,pagination:true,pageSize:20,fit:true,striped:true,url:'guarantee.do?datagrid&field=id,name,sex,birthday,age,idNumber,phone,address,createBy,createDate',method:'post',toolbar:'#tb'">
		<thead>
			<tr>
