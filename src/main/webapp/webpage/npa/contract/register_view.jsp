	...
	<form name="formobj" id="formobj" method="post" action="register.do?saveOrUpdate">
		...
		<div>
			...
			<table style="width: 100%;" cellpadding="0" cellspacing="1" class="viewtable">
				<tbody>
					<tr>
						<th><label class="required_sign">档案编号</label></th>
						...
						<td><input type="text" class="Wdate" onClick="WdatePicker({isShowClear:false,readOnly:true,maxDate:'#F{$dp.$D(\'dueDate\')}'})" name="loanContract.issueDate"
