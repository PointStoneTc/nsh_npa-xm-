...
<script type="text/javascript" src="${webRoot}/static/js/npa/contract/register_list.js"></script>
<link rel="stylesheet" href="${webRoot}/static/style/css/commcon.css">
</head>
<body>
	<table id="registerList" name="registerList" class="easyui-datagrid" title="借款合同登记列表"
		...
		<thead>
			<tr>
				...
				<th data-options="field:'isImpersonate',align:'center',formatter:formatRw">是否借冒名</th>
				...
				<th data-options="field:'stat',align:'center',formatter:formatCtstat">状态</th>
				<th data-options="field:'isSubmit',align:'center',formatter:formatRw">是否提交</th>
	...
	<div id="tb" style="padding: 2px 5px;">
		<table>
			<tr>
				...
				<td><input name="officer" id="officer" class="easyui-textbox" style="width: 110px" /></td>
