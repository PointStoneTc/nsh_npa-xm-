...
<script type="text/javascript"
	src="${webRoot}/static/js/npa/contract/error_updateBorrower.js"></script>
<link rel="stylesheet" href="${webRoot}/static/style/css/commcon.css">
</head>
<body style="width: 98%;">
	<form name="formobj" id="formobj" method="post"
		action="error.do?updateBorrower">
		<input type="hidden" name="ids" value="${ids }" /> <input
			type="hidden" name="indexs" id="indexs" value="${indexs }" /> <input
			type="hidden" name="sex" id="sex" value="" /> <input type="hidden"
			...
			<tbody>
				...
				<tr>
					...
					<td><input type="text" name="idNumber" id="idNumber"
						value="${idNumber }" maxlength="18" datatype="idNumber"
