...
<script type="text/javascript"
	src="${webRoot}/static/js/npa/contract/recall_list.js"></script>
	...
	<table id="recallList" class="easyui-datagrid" title="未完全收回款列表"
		...
		<thead>
			<tr>
				...
				<th
					data-options="field:'opt',align:'center',formatter:operate_formatter"
					, rowspan="2">操作</th>
			</tr>
		</thead>
		<thead>
			<tr>
				...
				<th
					data-options="field:'amountSurplus',align:'center', formatter:amountSurplus">贷款余额(元)</th>
				<th
