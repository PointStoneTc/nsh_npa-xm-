...
<script type="text/javascript"
	src="${webRoot}/static/js/npa/contract/query_list.js"></script>
...
<body>
	<div class="easyui-layout" fit="true">
		<div data-options="region:'center'" style="padding: 0px; border: 0px;">
			<table id="queryList" name="queryList" class="easyui-datagrid"
				title="借款合同综合查询"
				...
				<thead>
					<tr>
						...
						<th
							data-options="field:'stat',align:'center',formatter:formatCtstat"
							rowspan="2">状态</th>
					</tr>
				</thead>
				<thead>
					<tr>
						...
						<th
							data-options="field:'amount',align:'center',formatter:formatMoney">原贷金额(元)</th>
						<th
							data-options="field:'amountSurplus',align:'center',formatter:formatMoney">贷款余额(元)</th>
			...
			<div id="tb" style="padding: 2px 5px;">
				<table>
					<tr>
						...
						<td><input name="idNumber" id="idNumber"
							class="easyui-textbox" style="width: 330px" /></td>
						...
						<td><a id="printList" href="#" class="easyui-linkbutton"
							data-options="iconCls:'icon-print'" onclick="doPrintList()">添加到打印清单</a></td>
						<td><a id="printListClear" href="#" class="easyui-linkbutton"
							data-options="iconCls:'icon-clear'" onclick="doPrintListClear()">清空到打印区域</a></td>
						<td><a id="save" href="#" class="easyui-linkbutton"
							data-options="iconCls:'icon-save'" onclick="saveFile()">保存打印文件</a></td>
					</tr>
				</table>
			</div>
		</div>

		<div data-options="region:'south',title:'打印清单',split:true"
			style="height: 400px;">
			<div class="easyui-layout" fit="true">
				<div
					data-options="region:'west',border:true,split:true,collapsible:false,title:'未查到名单'"
					style="padding: 0px; border: 0px; width: 300px">
					<ul class="query-pdf-list" id="notFindexportList"></ul>
				</div>
				<div
					data-options="region:'center',border:true,split:true,title:'已查到名单'"
