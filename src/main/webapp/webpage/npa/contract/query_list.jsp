...
<body>
	<div class="easyui-layout" fit="true">
			...
			<div id="tb" style="padding: 2px 5px;">
				<table>
					<tr>
						...
						<td><a id="search" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-search'"
							onclick="doQuery()">查询</a></td>
						<td><a id="clear" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-le-back'"
							onclick="doClear()">清空</a></td>
						<td><a id="printList" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-print'"
							onclick="doPrintList()">添加到打印清单</a></td>
						<td><a id="printListClear" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-clear'"
							onclick="doPrintListClear()">清空到打印区域</a></td>
		...
		<div data-options="region:'south',title:'打印清单',split:true" style="height: 400px;">
			<div class="easyui-layout" fit="true">
				<div data-options="region:'west',border:true,split:true,collapsible:false,title:'未查到名单'"
