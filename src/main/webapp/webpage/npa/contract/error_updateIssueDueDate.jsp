...
<script type="text/javascript"
	src="${webRoot}/static/js/npa/contract/error_updateIssueDueDate.js"></script>
<link rel="stylesheet" href="${webRoot}/static/style/css/commcon.css">
</head>
<body style="width: 98%;">
	<form name="formobj" id="formobj" method="post"
		action="error.do?updateIssueDueDate">
			...
			<tbody>
				<tr>
					...
					<td><input type="text" class="Wdate"
						...
						name="issueDate" id="issueDate" value="${issueDate }" datatype="*"
				...
				<tr>
					...
					<td><input type="text" class="Wdate"
						...
						name="dueDate" id="dueDate" value="${dueDate }" datatype="*"
