...
<script type="text/javascript"
	src="${webRoot}/static/js/npa/contract/error_list.js"></script>
<link rel="stylesheet" href="${webRoot}/static/style/css/commcon.css">
</head>
<body>
	<table id="errorList" name="errorList" class="easyui-datagrid"
		title="错误借款合同列表"
		data-options="rownumbers:true,pagination:true,pageSize:20,fit:true,striped:true,url:'error.do?datagrid&field=id,numCode,customerNo,louNo,borrowerName,idNumber,amount,issueDate,dueDate,interestRate,officer,corporateOrgName,litigationStat,guaranteeMode,disposeMode,interestDate,recoveryPrincipal,recoveryInterest,hangInteres',method:'post',toolbar:'#tb'">
		<thead>
			<tr>
	...
	<div id="tb" style="padding: 2px 5px;">
		<table>
			<tr class="queryToolbarTable">
				...
				<td class="borderLeft"><a href="#" class="ace_button"
					alt="修改借款人" onclick="updateBorrower()"
					style="background-color: #9e123e;"><i class="fa fa-gavel"></i>修改借款人</a></td>
				<td class="borderLeft"><a href="#" class="ace_button"
					alt="修改贷款发放日" onclick="updateIssueDueDate()"
					style="background-color: #9e123e;"><i class="fa fa-gavel"></i>修改贷款发放日</a></td>
				<td class="borderLeft"><a href="#" class="ace_button" alt="提交"
					onclick="commit()" style="background-color: #9e123e;"><i
						class="fa fa-gavel"></i>提交</a></td>
			</tr>
		</table>
	</div>
</body>
