	...
	<div data-options="region:'west'" title="按步骤操作" style="width: 475px;">
		<table style="width: 100%;" cellpadding="0" cellspacing="1" class="viewtable">
			...
			<tr>
				...
				<td><a id="upload" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-put',disabled:true" onclick="upload()">上传Excel文件</a><a id="reload" href="#"
					class="easyui-linkbutton" data-options="iconCls:'icon-reload'" onclick="reloadTable()">刷新导入数据</a></td>
			...
			<tr>
				...
				<td><a id="createResult" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-edit',disabled:true" onclick="createResult()">生成结果</a></td>
				<td><div class="check_ok"></div></td>
			</tr>
			<tr>
				<th><label class="required_sign">(第5步)</label></th>
				<td><a id="insertDataBase" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-save',disabled:true" onclick="insertDataBase()">导入数据库</a></td>
				<td><div class="check_ok"></div></td>
			</tr>
			<tr>
		</table>
