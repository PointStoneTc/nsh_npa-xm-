...
<body style="overflow-y: hidden;">
	<div class="layout-admin">
		...
		<header class="layout-header">
			...
			<div class="titlerow">
				<div class="titlecell">
					<input id="searchbox" name="functionName" placeholder="请输入搜索关键字" class="searchbox"
						style="padding-right: 23px; border: 0">
					<div class="iconssdiv" onclick="checkput()">
						<i class="iconfont icon-close ui-iconss" style="font-weight: 700; font-size: 14px; display: none"></i> <i
							class="iconfont icon-sousuo ui-iconss"></i>
					</div>
				</div>
			</div>
			<ul class="header-bar">

				<li class="header-bar-nav personInfo hiddenty-xs" style="cursor: pointer;"><i class="icon-font">&#xe751;</i>&nbsp;
					<span>控制面板</span> <i class="icon-font adminIcon" style="margin-right: 5px;">&#xe607;</i>
					<ul class="header-dropdown-menu" style="padding-right: 4px">
						<li><a
							...
							title="系统消息">系统消息</a></li>
						<li><a href="javascript:window.open('http://yun.jeecg.org')" title="云应用中心">云应用中心</a></li>
				...
				<li class="header-bar-nav hiddenty-xs"><a
					href="javascript:add('首页风格','userController.do?changestyle','',550,250)" title="换肤"> <i class="icon-font">&#xe615;</i>&nbsp;风格切换
				</a></li>


				<li class="header-bar-nav personInfo"><a href="javascript:;" id="personInfo"> <span>
		...
		<section class="layout-main">
			<div class="layout-main-tab">
				<button onclick="toggleLeftMenu(this);" class="tab-btn btn-left" title="折叠菜单">
					<i class="icon-font">&#xe60e;</i>
				</button>
				...
				<nav class="tab-nav">
					<div class="tab-nav-content" id="tab-contents-div">
						...
						<a href="javascript:void(0);" id="myhomeAtag" class="content-tab active" data-id="home.html"> <span
								class="fa fa-home colorgray"></span>首页
						</a>
					</div>
				</nav>

				<button id="activeTabToolRefresh" class="tab-btn mytabbtn" style="right: 30px;" title="刷新本页">
			...
			<div class="layout-main-body" style="margin: 0; overflow-y: hidden;">
				<iframe class="body-iframe" name="iframe0" width="100%" height="100%" src="loginController.do?fineuiHome"
