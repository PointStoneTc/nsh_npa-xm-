...
<link rel="stylesheet" type="text/css"
	href="plug-in/themes/fineui/common/skin/qingxin/skin.css"
	id="layout-skin" />
<link rel="stylesheet"
	href="plug-in/themes/fineui/common/iconfont/iconfont.css">
<link rel="stylesheet"
	href="plug-in/themes/fineui/smart-menu/smartMenu.css">
...
<body style="overflow-y: hidden;">
	<div class="layout-admin">
		...
		<header class="layout-header">
			<span class="header-logo"><img alt="image" width="190"
				height="68" src="plug-in/login/images/jeecg-aceplus.png" /></span>

			<div class="titlerow">
				<div class="titlecell">
					<input id="searchbox" name="functionName" placeholder="请输入搜索关键字"
						class="searchbox" style="padding-right: 23px; border: 0">
					<div class="iconssdiv" onclick="checkput()">
						<i class="iconfont icon-close ui-iconss"
							style="font-weight: 700; font-size: 14px; display: none"></i> <i
			...
			<ul class="header-bar">
				...
				<li class="header-bar-nav personInfo hiddenty-xs"
					style="cursor: pointer;"><i class="icon-font">&#xe751;</i>&nbsp;
					<span>控制面板</span> <i class="icon-font adminIcon"
					...
					<ul class="header-dropdown-menu" style="padding-right: 4px">
						...
						<li><a href="javascript:window.open('http://yun.jeecg.org')"
							title="云应用中心">云应用中心</a></li>
				...
				<li class="header-bar-nav hiddenty-xs"><a
					href="javascript:add('首页风格','userController.do?changestyle','',550,250)"
					title="换肤"> <i class="icon-font">&#xe615;</i>&nbsp;风格切换
				</a></li>


				<li class="header-bar-nav personInfo"><a href="javascript:;"
					id="personInfo"> <span> <img
							src="plug-in/themes/fineui/common/image/head.jpg"
							style="width: 24px; display: inline-block; border-radius: 20px">
							<span>${userName}</span> <i class="icon-font adminIcon"
							style="margin-right: 5px;">&#xe607;</i>
					</span>
				</a>
