	...
	<div id="p1" title="JEECG简介" collapsible="true">
		<div title="JEECG简介" collapsible="true" closable="flase" style="height: 350px;">
			<div style="margin-top: 14px;">
				<h3>简介</h3>
				<p>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;JEECG（J2EE Code Generation）是一款基于代码生成器的智能快速开发平台，引领新开发模式(智能开发\在线开发\插件开发)，
					可以帮助解决Java项目80%的重复工作，让开发更多关注业务逻辑。既能快速提高开发效率，帮助公司节省人力成本，同时又不失灵活性。 <br>
					&nbsp;&nbsp;&nbsp;&nbsp;JEECG快速开发宗旨是：简单功能由代码生成器生成使用; 复杂业务采用表单自定义，业务流程使用工作流来实现、扩展出任务接口，供开发编写业务逻辑。
				...
				<ul>
					...
					<li>JEECG_<font color="red">v3.6 </font>最新版十二大技术点: <b>1.代码生成器</b> <b>2.用户权限</b> <b>3.Online在线开发</b> <b>简易Excel导入导出</b>
						<b>5.查询过滤器</b> <b>6.UI标签库</b> <b>7.国际化</b> <b>8.多数据源</b> <b>9.自定义表单</b> <b>10.在线报表配置</b> <b>11.系统日志监控</b> <b>12.首页风格切换</b></li>
					...
					<li>微信管家项目，请下载<a href="http://www.jeewx.com" target="_blank" style="color: red">Jeewx</a>，Jeecg 业务产品
					</li>
					<li>要求JDK1.6+</li>
				</ul>
			</div>
			<div style="margin-top: 20px;">
				...
				<ul>
					...
					<li><a href="http://www.jeecg.org/forum.php?mod=viewthread&tid=1834&extra=page%3D1" target="_blank"
						style="color: red"> >>更多商业支持，请联系官方</a></li>
				</ul>
			</div>
		</div>
		...
		<div id="p2" title="系统提醒">
			<div class="easyui-layout" fit="true">
				<div region="center" style="padding: 0px; border: 0px;">
					<t:datagrid name="noticeList" title="common.notice" actionUrl="noticeController.do?datagrid" idField="id"
