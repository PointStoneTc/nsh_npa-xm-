		...
		<div class="navbar-container" id="navbar-container">
			...
			<div class="navbar-buttons navbar-header pull-right" role="navigation">
				<ul class="nav ace-nav">
					...
					<li class="light-blue" style="margin-top: 16px;"><a data-toggle="dropdown" href="#" class="dropdown-toggle">
							<%--<img class="nav-user-photo" src="plug-in/ace/avatars/user.jpg" alt="Jason's Photo" />--%> <span
								class="user-info">
	...
	<div class="main-container" id="main-container">
		...
		<div id="sidebar" class="sidebar                  responsive">
			...
			<ul class="nav nav-list">
				<li class=""><a href="javascript:loadModule('首页','loginController.do?home')"> <i
						class="menu-icon fa fa-home"></i> <span class="menu-text"> 首页 </span>
				...
				<div class="page-content-area" data-ajax-content="false">
					<div id="tabs">
						...
						<ul class="nav nav-tabs" role="tablist" style="height: 35px;">
							<li role="presentation" class="active"><a href="#tabs-1" aria-controls="tabs-1" role="tab" data-toggle="tab">首页<i
						...
						<div class="tab-content">
							<div id="tabs-1" style="padding: 0px" role="tabpanel" class="tab-pane active">
								<iframe style="width: 100%; height: 700px; margin: 0px; padding: 0px" scrolling="auto" frameborder="0"
