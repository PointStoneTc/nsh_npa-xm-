	...
	<div class="wrapper wrapper-content">
		...
		<div class="row">
			...
			<div class="col-sm-3" style="padding-left: 10px;">
				...
				<iframe name="weather_inc" src="http://i.tianqi.com/index.php?c=code&id=7" style="border: solid 1px #7ec8ea"
					width="105%" height="90" frameborder="0" marginwidth="0" marginheight="0" scrolling="no"></iframe>
				<div id="calendar"></div>
			</div>
		</div>
		<div class="row">
							...
							<div class="panel-body">
								<div class="panel-group" id="version">
									<div class="panel panel-default">
										<div class="panel-heading">
											<h5 class="panel-title">
												<a data-toggle="collapse" data-parent="#version" href="#v56">v3.7.8</a>
												<code class="pull-right">2018.08.06</code>
											</h5>
										</div>
									...
									<div class="panel panel-default">
										<div class="panel-heading">
											<h5 class="panel-title">
												<a data-toggle="collapse" data-parent="#version" href="#v55">v3.7.7</a>
												<code class="pull-right">2018.07.16</code>
											</h5>
										</div>
										<div id="v55" class="panel-collapse collapse">
											<div class="panel-body">
												<div class="alert alert-warning">此版本为性能和表单UI深化加强版本，简称闪电版本
													（闪电般的速度，主流的Bootstrap表单风格）。平台性能访问速度提升至少3倍；表单提供Bootstrap风格极大提升美感和代码可控性，降低了表单的开发成本；</div>
												<ol>
													<li>【新功能】一套新的代码生成器模板，Bootstrap表单+EasyUI列表（单表、一对多）;</li>
													<li>【新功能】一套新的代码生成器模板，Bootstrap表单+EasyUI原生列表（单表、一对多）;</li>
													<li>【新功能】一套新的代码生成器模板， Boostrap表单+BootstapTable原生列表（单表、一对多）;</li>
									...
									<div class="panel panel-default">
										<div class="panel-heading">
											<h5 class="panel-title">
												<a data-toggle="collapse" data-parent="#version" href="#v54">v3.7.6</a>
												<code class="pull-right">2018.06.06</code>
											</h5>
										</div>
										<div id="v54" class="panel-collapse collapse">
											<div class="panel-body">
												<div class="alert alert-warning">此版本提供新一代风格代码生成器模板，采用Vue技术，提供两套精美模板
									...
									<div class="panel panel-default">
										<div class="panel-heading">
											<h5 class="panel-title">
												<a data-toggle="collapse" data-parent="#version" href="#v53">v3.7.5</a>
												<code class="pull-right">2018.05.17</code>
											</h5>
										</div>
									...
									<div class="panel panel-default">
										<div class="panel-heading">
											<h5 class="panel-title">
												<a data-toggle="collapse" data-parent="#version" href="#v52">v3.7.3</a>
												<code class="pull-right">2018.03.13</code>
											</h5>
										</div>
									...
									<div class="panel panel-default">
										<div class="panel-heading">
											<h5 class="panel-title">
												<a data-toggle="collapse" data-parent="#version" href="#v51">v3.7.2</a>
												<code class="pull-right">2018.01.25</code>
											</h5>
										</div>
										<div id="v51" class="panel-collapse collapse">
											<div class="panel-body">
												<div class="alert alert-warning">此版本为接口开发版，采用jwt
													token统一验证机制，集成swagger-ui，代码生成器自动生成所需接口；另外此版本UI样式进行刮骨疗法深度优化，极大提升UI美感！</div>
												<ol>
									...
									<div class="panel panel-default">
										<div class="panel-heading">
											<h5 class="panel-title">
												...
												<code class="pull-right">2017.09.18</code>
											</h5>
										</div>
