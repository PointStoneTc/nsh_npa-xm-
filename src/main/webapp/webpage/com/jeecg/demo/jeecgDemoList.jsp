...
<div class="easyui-layout" fit="true">
	<div region="center" style="padding: 0px; border: 0px">
		<t:datagrid name="jeecgDemoList" checkbox="true" sortName="birthday,name" pagination="true" fitColumns="false"
			title="jeecg_demo" superQuery="true" actionUrl="jeecgListDemoController.do?datagrid" idField="id" fit="true"
			queryMode="group" filter="true">
			<t:dgCol title="id" field="id" hidden="true" queryMode="group" width="120"></t:dgCol>
			<t:dgCol title="名称" frozenColumn="true" popup="true" dictionary="user_msg,name@email,account@realname" field="name"
				query="true" autocomplete="true" width="120" extend="{style:'width:120px'}"></t:dgCol>

			<!-- 字段 formatterjs 例子 -->
			<t:dgCol title="年龄" frozenColumn="true" extend="{style:'width:70px'}" formatterjs="formatAgeFun"
				style="background-color:#3a87ad_50,background-color:#f89406_100" editor="numberbox" field="age" query="true"
				width="120"></t:dgCol>

			<t:dgCol title="生日" hidden="true" field="birthday" formatter="yyyy-MM-dd" queryMode="group" width="120"></t:dgCol>
			<t:dgCol title="部门" frozenColumn="true" field="depId" query="true" queryMode="single"
				dictionary="t_s_depart,id,departname" width="120"></t:dgCol>
			<t:dgCol title="部门编码(拓展字段)" frozenColumn="true" field="extField"></t:dgCol>
			<t:dgCol title="性别" field="sex" frozenColumn="true" query="false" showMode="radio" dictionary="sex" width="120"
			...
			<t:dgToolBar title="弹出TAB表单" inGroup="true" icon="icon-add" url="jeecgListDemoController.do?goAdd" funname="addbytab"
				width="770" height="500"></t:dgToolBar>
			<t:dgToolBar title="录入-提交按钮" inGroup="true" icon="icon-add" url="jeecgListDemoController.do?addWithbtn"
				funname="addWithbtn" width="770"></t:dgToolBar>
			...
			<t:dgToolBar title="查看" inGroup="true" icon="icon-search" url="jeecgListDemoController.do?goUpdate" funname="detail"
			...
			<t:dgToolBar operationCode="print" title="打印" inGroup="true" icon="icon-print" url="jeecgListDemoController.do?print"
...
<script type="text/javascript">
  ...
  function szqm(id) {
    createwindow('审核入职', 'jeecgListDemoController.do?goCheck&id=' + id, 420,
            280);
  }
