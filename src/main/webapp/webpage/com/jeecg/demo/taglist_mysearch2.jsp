...
<div class="easyui-layout" fit="true">
	<div region="center" style="padding: 0px; border: 0px">
		<t:datagrid name="jeecgMysearchList" pageSize="500" checkbox="true" pagination="true" fitColumns="false"
			title="自定义列表查询条件二" actionUrl="jeecgListDemoController.do?datagrid" idField="id" fit="true">
		...
		<div id="jeecgMysearchListtb" style="padding: 3px; height: 27px; border-bottom: 1px solid #D7D7D7">
			<div style="float: left;" class="searchColums">
				名称：<input class="inuptxt ac_input" type="text" name="name"> 年龄：<input class="easyui-validatebox" type="text"
					name="age">
			</div>
			<div align="right">
				<a href="#" class="easyui-linkbutton" iconCls="icon-search" onclick="jeecgMysearchListsearch();">查询</a> <a href="#"
