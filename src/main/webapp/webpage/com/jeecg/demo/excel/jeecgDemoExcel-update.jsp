...
<body>
	<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table"
		action="jeecgDemoExcelController.do?doUpdate" tiptype="1">
			...
			<div class="con-wrapper" id="con-wrapper1" style="display: block;">
				<div class="row form-wrapper">
					...
					<div class="row show-grid">
						...
						<div class="col-xs-3">
							<t:dictSelect field="sex" type="list" extendJson="{class:'form-control'}" typeGroupCode="sex"
								defaultVal="${jeecgDemoExcelPage.sex}" hasLabel="false" title="性别"></t:dictSelect>
							<span class="Validform_checktip" style="float: left; height: 0px;"></span>
					...
					<div class="row show-grid">
						...
						<div class="col-xs-3">
							<t:dictSelect field="depart" type="list" extendJson="{class:'form-control'}" dictTable="t_s_depart"
								dictField="id" dictText="departname" defaultVal="${jeecgDemoExcelPage.depart}" hasLabel="false" title="关联部门"></t:dictSelect>
							<span class="Validform_checktip" style="float: left; height: 0px;"></span>
					...
					<div class="row show-grid">
						...
						<div class="col-xs-3">
							<input id="fdReplace" name="fdReplace" maxlength="255" type="text" class="form-control" ignore="ignore"
								value='${jeecgDemoExcelPage.fdReplace}' />
							<span class="Validform_checktip" style="float: left; height: 0px;"></span>
					...
					<div class="row show-grid">
						...
						<div class="col-xs-3">
							<input id="fdConvert" name="fdConvert" maxlength="255" type="text" class="form-control" ignore="ignore"
								value='${jeecgDemoExcelPage.fdConvert}' />
							<span class="Validform_checktip" style="float: left; height: 0px;"></span>
