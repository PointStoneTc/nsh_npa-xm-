	...
	<tbody id="add_jfromOrderLine_table">
		<c:if test="${fn:length(jfromOrderLineList)  <= 0 }">
			<tr>
				...
				<td align="left"><input name="jfromOrderLineList[0].itemName" maxlength="128" type="text" class="inputxt"
					style="width: 120px;" ignore="ignore"> <label class="Validform_label" style="display: none;">商品名称</label></td>
				<td align="left"><input name="jfromOrderLineList[0].qty" maxlength="32" type="text" class="inputxt"
					style="width: 120px;" datatype="n" ignore="ignore"> <label class="Validform_label" style="display: none;">商品数量</label></td>
				<td align="left"><input name="jfromOrderLineList[0].price" maxlength="32" type="text" class="inputxt"
					style="width: 120px;" ignore="ignore"> <label class="Validform_label" style="display: none;">商品价格</label></td>
				<td align="left"><input name="jfromOrderLineList[0].amount" maxlength="32" type="text" class="inputxt"
		...
		<c:if test="${fn:length(jfromOrderLineList)  > 0 }">
			<c:forEach items="${jfromOrderLineList}" var="poVal" varStatus="stuts">
				<tr>
					...
					<td align="left"><input name="jfromOrderLineList[${stuts.index }].itemName" maxlength="128" type="text"
						class="inputxt" style="width: 120px;" ignore="ignore" value="${poVal.itemName }" /> <label
							class="Validform_label" style="display: none;">商品名称</label></td>
					<td align="left"><input name="jfromOrderLineList[${stuts.index }].qty" maxlength="32" type="text"
						class="inputxt" style="width: 120px;" datatype="n" ignore="ignore" value="${poVal.qty }" /> <label
							class="Validform_label" style="display: none;">商品数量</label></td>
					<td align="left"><input name="jfromOrderLineList[${stuts.index }].price" maxlength="32" type="text"
						class="inputxt" style="width: 120px;" ignore="ignore" value="${poVal.price }" /> <label class="Validform_label"
							style="display: none;">商品价格</label></td>
					<td align="left"><input name="jfromOrderLineList[${stuts.index }].amount" maxlength="32" type="text"
						class="inputxt" style="width: 120px;" ignore="ignore" value="${poVal.amount }" /> <label class="Validform_label"
