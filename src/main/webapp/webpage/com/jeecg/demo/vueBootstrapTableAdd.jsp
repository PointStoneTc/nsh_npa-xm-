	...
	<div id="dpLTE" class="container-fluid" v-cloak>
		<table class="form" id="form">
			<tr>
				...
				<td class="formValue"><input type="text" class="form-control" placeholder="姓名" v-model="user.name" datatype="*"></td>
				<td class="formTitle">年龄<font face="宋体">*</font></td>
				<td class="formValue"><input type="text" class="form-control" placeholder="年龄" v-model="user.age"
					datatype="num"></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="formValue"><input type="text" id="birthday" class="form-control" placeholder="请选择生日"></td>
				<td class="formTitle">手机号</td>
				<td class="formValue">
					<!--update-begin-Author:zhangweijian Date: 20180710 for：TASK #2941 【bug】常用示例，小问题，手机号校验--> <input type="text"
					class="form-control" placeholder="请输入手机号" v-model="user.phone" datatype="m"> <!--update-end-Author:zhangweijian Date: 20180710 for：TASK #2941 【bug】常用示例，小问题，手机号校验-->
				</td>
			</tr>
		</table>
	</div>
