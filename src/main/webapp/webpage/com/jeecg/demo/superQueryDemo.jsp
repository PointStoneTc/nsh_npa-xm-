...
<div class="easyui-layout" fit="true">
	<div region="center" style="padding: 1px;">
		<t:datagrid name="jeecgDemoList2" title="高级查询示例" actionUrl="jeecgListDemoController.do?datagrid" idField="id"
         ...
         onAfterEdit:function(node){  
					...
					<thead>
						<tr>
							...
							data:  
								...
								{'conditionId':'=','conditionName':'等于'},
								{'conditionId':'>','conditionName':'大于'},
								{'conditionId':'<','conditionName':'小于'}, {'conditionId':'like','conditionName':'包含'},
								{'conditionId':'in','conditionName':'在其中'} ], required:true }}">条件</th>
							<th data-options="field:'value',width:30,editor:'text'">值</th>
							<th data-options="field:'opt',width:30,formatter:function(value,row){
							return '<a  onclick=\'removeIt('+row.id+')\' >
								删除</a>'; }">操作
							</th>
						</tr>
					</thead>
			...
			<div data-options="region:'south',border:false" style="text-align: right; padding: 5px 0 0;">
				<a class="easyui-linkbutton" data-options="iconCls:'icon-ok'" href="javascript:void(0)"
					onclick="javascript:queryBuilderSearch()">OK</a> <a class="easyui-linkbutton" data-options="iconCls:'icon-cancel'"
					href="javascript:void(0)" onclick="javascript:$('#w').window('close')">Cancel</a>
			</div>
		</div>
	</div>
</div>
