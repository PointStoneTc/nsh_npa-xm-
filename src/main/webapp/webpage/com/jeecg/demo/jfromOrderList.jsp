...
<div class="easyui-layout" fit="true">
	<div region="center" style="padding: 0px; border: 0px">
		<t:datagrid name="jfromOrderList" checkbox="true" fitColumns="true" complexSuperQuery="jfrom_order" title="订单列表"
			actionUrl="jfromOrderController.do?datagrid" isShowSubGrid="true" configId="jfrom_order" idField="id" fit="true"
			queryMode="group">
			...
			<t:dgToolBar title="编辑" icon="icon-edit" url="jfromOrderController.do?goUpdate" funname="update" width="100%"
			...
			<t:dgToolBar title="查看" icon="icon-search" url="jfromOrderController.do?goUpdate" funname="detail" width="100%"
				height="100%"></t:dgToolBar>
