...
<body>
			...
			<div class="tab-opts-menu" id="tab-menus-main" style="font-size: 14px">
				<div class="opts-menu-box">
					...
					<div class="menus table-menu-0" style="top: -1px">
						<a title="重置" onclick="mainPageQueryReset()" href="####" class="btn-menu fa fa-refresh menu-more"></a> <a
							title="查询" onclick="associatedQuery('jformOrderMain2','jformOrderMain2List')" href="####"
			...
			<div id="accDiv" class="easyui-accordion" data-options="multiple:true"
				...
				<div title="订单信息" data-options="iconCls:'icon-ok',selected:true">
					<div id="easyui_mainList" class="resize-y-iframe" style="height: 286px; padding-bottom: 6px;">
						<iframe id="mainList" height="99%" width="100%" frameborder="0" src="${webRoot}/jformOrderMain2Controller.do?list"></iframe>
					</div>
				</div>
			</div>
			<!-- 上方end -->
			...
			<div class="tab-opts-menu" id="tab-menus-attached" style="font-size: 14px">
				<div class="opts-menu-box">
					<div class="menus testContractItem-ul active">
						<t:menuButtons codes="addSingle,editSingle,batchDel,save,reject,template,importe,export,filter"
	...
	<div style="display: none">
		<!-- 激活选项卡再刷新页面需要该隐藏域 -->
		<input type="hidden" id="mainPageHiddenId"> <select id="mainPageFrameActived" style="display: none">
