...
<div class="easyui-layout" fit="true">
	<div region="center" style="padding: 0px; border: 0px">
		<t:datagrid name="jformOrderCustomer2List" filterBtn="true" onDblClick="datagridDbclick" checkbox="true"
			pagination="true" fitColumns="true" title="" actionUrl="jformOrderCustomer2Controller.do?datagrid" idField="id"
			...
			<t:dgCol title="单价" field="money" filterType="numberbox"
				extendParams="editor:{type:'validatebox',options:{validType:'decimalTwo'}}" queryMode="group" width="120"></t:dgCol>
			<t:dgCol title="性别" field="sex" extendParams="editor:'combobox'" filterType="combobox" queryMode="single"
			...
			<t:dgDelOpt title="删除" url="jformOrderCustomer2Controller.do?doDel&id={id}" urlclass="ace_button"
				urlfont="fa-trash-o" />
