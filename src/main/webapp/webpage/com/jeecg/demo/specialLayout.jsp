...
<div>
	<div class="easyui-layout" fit="true">
		<div region="center" style="padding: 0px; border: 0px">
			<t:datagrid name="jeecgrowList" pagination="true" fitColumns="true" title="数据列表"
				actionUrl="jeecgListDemoController.do?datagrid" pageSize="5" idField="id" queryMode="group">
...
<div title="新增数据" style="height: 350px; background-color: #fff; overflow-y: auto;" name="editPanel" id="editPanel">
	<div class="datagrid-toolbar" style="float: left; width: 100%;">
		<a href="#" class="easyui-linkbutton l-btn l-btn-plain" plain="true" icon="icon-add" onclick="clearData()"> 清空表单 </a>
		<a href="#" class="easyui-linkbutton l-btn l-btn-plain" plain="true" icon="icon-undo" onclick="cancelEdit()"> 重置表单
		</a> <a href="#" class="easyui-linkbutton l-btn l-btn-plain" plain="true" icon="icon-save" id="btn_sub"
		...
		<table style="width: 600px; margin-bottom: 75px" cellpadding="0" cellspacing="1" class="formtable">
			<tbody>
				<tr>
					...
					<td class="value"><input id="name" name="demos[0].name" type="text" style="width: 150px;" class="inputxt"
						datatype="*" value=""></td>
					<td align="right"><label class="Validform_label"> 年龄: </label></td>
					<td class="value"><input id="age" name="demos[0].age" type="text" style="width: 150px;" class="inputxt"
						datatype="d" value=""></td>
				...
				<tr>
					...
					<td class="value"><input id="salary" name="demos[0].salary" type="text" style="width: 150px;" class="inputxt"
						value=""></td>
				...
				<tr>
					...
					<td class="value" colspan="5"><textarea name="demos[0].content" id="content"
