...
<div class="easyui-layout" fit="true">
	<div region="center" style="padding: 0px; border: 0px">
		<t:datagrid name="jeecgMinidaoList" pageSize="500" pagination="false" fitColumns="false" title="用户操作统计报表"
			actionUrl="jeecgListDemoController.do?logrpDatagrid" idField="id" fit="true" queryMode="group">
