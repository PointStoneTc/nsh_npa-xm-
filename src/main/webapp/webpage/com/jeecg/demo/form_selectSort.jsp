		...
		<fieldset>
			...
			<table>
				<tr>
					...
					<td class="value"><input id="id" name="id" type="hidden" value="" /> <input name="realName" class="inputxt"
						value="" id="realName" readonly="readonly" datatype="*" /> <%-- <t:choose hiddenName="roleid" hiddenid="id" url="userController.do?roles" name="roleList" icon="icon-search" title="选择操作标签" textname="roleName" isclear="true" isInit="true"></t:choose> --%>
					...
					</a> <a href="#" class="easyui-linkbutton l-btn l-btn-plain" plain="true" id="departRedo" onclick="callbackClean()">
