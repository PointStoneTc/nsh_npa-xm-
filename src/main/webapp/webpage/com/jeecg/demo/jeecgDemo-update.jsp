...
<body>
	<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table"
		action="jeecgListDemoController.do?doUpdate">
		...
		<table style="width: 90%;" cellpadding="0" cellspacing="1" class="formtable">
			<tr>
				...
				<td class="value"><input id="name" name="name" type="text" style="width: 150px" class="inputxt" datatype="*"
					value='${jeecgDemoPage.name}'> <span class="Validform_checktip"></span> <label class="Validform_label"
			...
			<tr>
				...
				<td class="value"><input id="age" name="age" type="text" style="width: 150px" class="inputxt" datatype="d"
					value='${jeecgDemoPage.age}'> <span class="Validform_checktip"></span> <label class="Validform_label"
			...
			<tr>
				...
				<td class="value"><input id="birthday" name="birthday" type="text" style="width: 150px" class="Wdate"
					onClick="WdatePicker()"
					value='<fmt:formatDate value='${jeecgDemoPage.birthday}' type="date" pattern="yyyy-MM-dd"/>'> <span
						class="Validform_checktip"></span> <label class="Validform_label" style="display: none;">生日</label></td>
			</tr>
			...
			<tr>
				...
				<td class="value"><input id="email" name="email" type="text" style="width: 150px" class="inputxt" datatype="e"
					value='${jeecgDemoPage.email}'> <span class="Validform_checktip"></span> <label class="Validform_label"
			...
			<tr>
				...
				<td class="value"><input id="phone" name="phone" type="text" style="width: 150px" class="inputxt" datatype="m"
					value='${jeecgDemoPage.phone}'> <span class="Validform_checktip"></span> <label class="Validform_label"
						style="display: none;">电话</label></td>
			</tr>
			<tr>
				<td align="right"><label class="Validform_label"> 工资: </label></td>
				<td class="value"><input id="salary" name="salary" type="text" style="width: 150px" class="inputxt"
					value='${jeecgDemoPage.salary}' datatype="d" /> <span class="Validform_checktip"></span> <label
			...
			<tr>
				...
				<td class="value"><t:dictSelect field="status" type="list" typeGroupCode="sf_yn"
						defaultVal="${jeecgDemoPage.status}" hasLabel="false" title="入职状态"></t:dictSelect> <span
			...
			<tr>
				...
				<td class="value"><t:webUploader type="image" displayTxt="false" bizType="photosucai" name="touxiang"
						auto="false" pathValues="${jeecgDemoPage.touxiang}" datatype="*" nullMsg="请选择头像(自定义提示信息)"></t:webUploader></td>
			</tr>

			<tr>
				<td align="right"><label class="Validform_label"> 附件: </label></td>
				<td class="value"><t:webUploader auto="true" pathValues="${jeecgDemoPage.fujian}" name="fujian"
						duplicate="true" fileNumLimit="3" datatype="*" nullMsg="请选择附件(自定义提示信息)"></t:webUploader></td>
			</tr>
			<tr>
				...
				<td class="value"><script type="text/javascript" charset="utf-8" src="plug-in/ueditor/ueditor.config.js"></script>
					<script type="text/javascript" charset="utf-8" src="plug-in/ueditor/ueditor.all.min.js"></script> <textarea
						name="content" readonly="true" id="content" style="width: 100%; height: 300px">${jeecgDemoPage.content}</textarea>
