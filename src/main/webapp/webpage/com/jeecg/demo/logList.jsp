...
<t:datagrid title="日志" name="logList" actionUrl="jeecgListDemoController.do?logDatagrid" idField="id"
	sortName="operatetime" sortOrder="desc" queryMode="group" pageSize="500" extendParams="view:scrollview,">
