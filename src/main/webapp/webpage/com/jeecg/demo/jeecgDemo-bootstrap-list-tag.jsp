...
<body>
	<t:datagrid name="jeecgDemoList1" checkbox="true" component="bootstrap-table" sortName="createDate,name"
		...
		<t:dgCol title="邮箱" field="email" query="true" popup="true" dictionary="user_msg,name@email,account@realname"
			width="120"></t:dgCol>
		...
		<t:dgDelOpt title="删除" url="jeecgListDemoController.do?doDel&id={id}" urlclass="btn btn-danger btn-xs"
			urlfont="fa-trash-o" />
		<t:dgToolBar title="录入" icon="icon-add" url="jeecgListDemoController.do?goBootStrapTableAdd" funname="add" width="770"
			height="500"></t:dgToolBar>
		<t:dgToolBar title="编辑" icon="icon-edit" url="jeecgListDemoController.do?goBootStrapTableUpdate" funname="update"
