		...
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="jeecgDemoController.do?save">
			...
			<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				...
				<tr>
					...
					<td class="value"><fmt:formatDate value='${jgDemo.birthday }' type="date" pattern="yyyy-MM-dd" /></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="value"><fmt:formatDate value='${jgDemo.createDate}' type="date" pattern="yyyy-MM-dd HH:m:ss" /></td>
				</tr>
