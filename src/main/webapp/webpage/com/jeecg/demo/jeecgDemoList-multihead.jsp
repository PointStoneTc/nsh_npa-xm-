...
<div class="easyui-layout" fit="true">
	<div region="center" style="padding: 0px; border: 0px">
		<t:datagrid name="jeecgDemoList" checkbox="true" sortName="birthday,name" pagination="true" fitColumns="true"
			title="多表头列表 Demo" actionUrl="jeecgListDemoController.do?datagrid" idField="id" fit="true" queryMode="group">
			...
			<t:dgCol title="创建日期" field="createDate" rowspan="2" formatter="yyyy-MM-dd" queryMode="group" editor="datebox"
				width="120"></t:dgCol>
			...
			<t:dgCol title="年龄" extend="{style:'width:50px'}" style="background-color:#3a87ad_50,background-color:#f89406_100"
