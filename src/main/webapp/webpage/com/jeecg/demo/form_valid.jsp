...
<body>
	<t:formvalid formid="formobj" dialog="false" layout="div" callback="test"
		action="jeecgFormvalidController.do?testsubmit=2" beforeSubmit="setContentc">
		<fieldset class="step" style="padding-bottom: 20px;">
			...
			<div class="form">
				...
				<input name="shoppingsite1" class="rt2" id="shoppingsite21" type="checkbox" value="1" datatype="need2"
					nullmsg="请选择您的爱好！" />阅读 <input name="shoppingsite1" class="rt2" id="shoppingsite22" type="checkbox" value="2" />
				音乐 <input name="shoppingsite1" class="rt2" id="shoppingsite23" type="checkbox" value="3" /> 运动
				<span class="Validform_checktip"></span>
			</div>
			...
			<div class="form">
				<label class="Validform_label"> 时间： </label>
				<input id="d12" type="text" datatype="*" errormsg="该字段不为空" /> <img onclick="WdatePicker({el:'d12'})"
					src="plug-in/easyui/themes/black/images/datebox_arrow.png" style="opacity: 0.6; height: 17px; width: 17px;"
					align="absmiddle">
				<span class="Validform_checktip"></span>
			</div>
	...
	<t:formvalid formid="formobj2" tiptype="6" dialog="false" layout="div" callback="test"
		action="jeecgFormvalidController.do?testsubmit=2" beforeSubmit="setContentc">
		<fieldset class="step" style="padding-bottom: 20px;">
			...
			<div class="form">
				<label class="Validform_label"> 至少选择2项： </label>
				<input name="shoppingsite12" class="rt2" id="shoppingsite21" type="checkbox" value="1" datatype="need2"
					nullmsg="请选择您的爱好！" />阅读 <input name="shoppingsite12" class="rt2" id="shoppingsite22" type="checkbox" value="2" />
				音乐 <input name="shoppingsite12" class="rt2" id="shoppingsite23" type="checkbox" value="3" /> 运动
				<span class="Validform_checktip"></span>
			</div>
			...
			<div class="form">
				<label class="Validform_label"> 时间： </label>
				<input id="d122" type="text" datatype="*" errormsg="该字段不为空" /> <img onclick="WdatePicker({el:'d122'})"
					src="plug-in/easyui/themes/black/images/datebox_arrow.png" style="opacity: 0.6; height: 17px; width: 17px;"
					align="absmiddle">
				<span class="Validform_checktip"></span>
			</div>
