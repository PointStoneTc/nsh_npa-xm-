...
<div class="easyui-layout" fit="true">
	<div region="center" style="padding: 0px; border: 0px">
		<t:datagrid name="jeecgMinidaoList" checkbox="true" pagination="true" fitColumns="false"
			title="用户Demo列表，采用minidao查询数据" actionUrl="jeecgListDemoController.do?minidaoDatagrid" idField="id" fit="true"
			queryMode="group">
			...
			<t:dgCol title="创建日期" field="createDate" formatter="yyyy-MM-dd" query="false" queryMode="group" editor="datebox"
				width="120"></t:dgCol>
			...
			<t:dgToolBar title="调用存储批量删除用户DEMO" icon="icon-add" url="jeecgListDemoController.do?jdbcProcedure"
