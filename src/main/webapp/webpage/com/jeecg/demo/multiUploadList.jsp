...
<div class="easyui-layout" fit="true">
	<div region="center" style="padding: 0px; border: 0px">
		<t:datagrid name="multiUploadList" checkbox="false" pagination="true" fitColumns="true" title="测试多文件上传"
			actionUrl="multiUploadController.do?datagrid" idField="id" fit="true" queryMode="group">
