...
public interface LoanContractErrorServiceI extends CommonService {
   ...
   * @throws Exception
   */
  boolean updateBorrower(String ids, String name, String sex, Date birthday, String idNumber, String address) throws Exception;
   ...
   * @throws Exception
   */
  boolean updateGuarantee(String id, String guaranteesNames, String guaranteesIdNumbers, String guaranteesAddresses) throws Exception;
