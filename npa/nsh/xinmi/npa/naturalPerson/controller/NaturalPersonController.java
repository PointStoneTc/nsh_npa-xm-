...
public class NaturalPersonController extends BaseController {
  ...
  @ResponseBody
  public AjaxJson idNumberIsExist(@RequestParam(value = "name", required = true) String name, @RequestParam(value = "idNumber", required = true) String idNumber,
    ...
    try {
      ...
      j.setMsg("查询成功!");
      logger.info("query idNumberIsExist sucess: " + name + ":" + idNumber);
    } catch (Exception e) {
      j.setSuccess(false);
