...
public class CgAutoListController extends BaseController {
    ...
    public void datagrid(String configId, String page, String field, String rows, String sort, String order, HttpServletRequest request, HttpServletResponse response,
    ...
    public AjaxJson del(String configId, String id, HttpServletRequest request) {
        ...
        // String jversion = cgFormFieldService.getCgFormVersionByTableName(configId);
        // String table = (String)
        // configService.queryConfigs(configId,jversion).get(CgAutoListConstant.TABLENAME);
    ...
    private void loadIframeConfig(Map<String, Object> paras, HttpServletRequest request) {
        ...
        if (!request.getQueryString().contains("isHref")) {
            ...
            // href=\"plug-in/easyui/themes/"+cssTheme+"/easyui.css\" type=\"text/css\"></link>");
            sb.append(SysThemesUtil.getEasyUiTheme(sysThemesEnum));
            sb.append(SysThemesUtil.getEasyUiIconTheme(sysThemesEnum));
            // sb.append("<link rel=\"stylesheet\" href=\"plug-in/easyui/themes/icon.css\"
            // type=\"text/css\"></link>");
            ...
            // sb.append("<link id=\"easyuiTheme\" rel=\"stylesheet\"
            // href=\"plug-in/easyui/themes/"+cssTheme+"/main.css\" type=\"text/css\"></link>");
            // }
    ...
    private List<DictEntity> queryDic(String dicTable, String dicCode, String dicText) {
        ...
        // dicSql.append(" "+"(SELECT ID FROM "+CgAutoListConstant.SYS_DICGROUP+" WHERE TYPEGROUPCODE =
        // '"+dicCode+"' )");
