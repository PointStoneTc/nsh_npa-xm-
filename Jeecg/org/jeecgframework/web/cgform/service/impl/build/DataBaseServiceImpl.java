            ...
            if (oConvertUtils.isNotEmpty(beforeV)) {
                ...
                if ("date".equalsIgnoreCase(type)) {
                    ...
                    try {
                        ...
                        /*
                         * String dateType = fieldConfig.getShowType(); if("datetime".equalsIgnoreCase(dateType)){ newV =
                         * new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").parse(String.valueOf(beforeV)); }else
                         * if("date".equalsIgnoreCase(dateType)){ newV = new
                         * SimpleDateFormat("yyyy-MM-dd").parse(String.valueOf(beforeV)); }
                         */
