...
public class CgReportQueryParamUtil {
     ...
     */
    /*
     * public static String applyType(String fieldType, String value) { if(!StringUtil.isEmpty(value)){
     * String result = ""; if(CgReportConstant.TYPE_STRING.equalsIgnoreCase(fieldType)){
     * 
     * //if(ResourceUtil.fuzzySearch&&(!value.contains("*"))){ // value="*"+value+"*"; //}
     * 
     * // result = "'" +value+ "'"; result = value;
     * 
     * }else if(CgReportConstant.TYPE_DATE.equalsIgnoreCase(fieldType)){ result = getDateFunction(value,
     * "yyyy-MM-dd"); }else if(CgReportConstant.TYPE_DOUBLE.equalsIgnoreCase(fieldType)){ result =
     * value; }else if(CgReportConstant.TYPE_INTEGER.equalsIgnoreCase(fieldType)){ result = value;
     * }else{ result = value; } return result; }else{ return ""; } }
     */
     ...
     */
    /*
     * public static String getDateFunction(String dateStr,String dateFormat){ String dbType =
     * getDBType(); String dateFunction = ""; if("mysql".equalsIgnoreCase(dbType)){ //mysql日期函数
     * dateFunction = "'"+dateStr+"'"; }else if("oracle".equalsIgnoreCase(dbType)){ //oracle日期函数
     * dateFunction = "TO_DATE('"+dateStr+"','"+dateFormat+"')"; }else
     * if("sqlserver".equalsIgnoreCase(dbType)){ //sqlserver日期函数 dateFunction =
     * "(CONVERT(VARCHAR,'"+dateStr+"') as DATETIME)"; }else if("postgres".equalsIgnoreCase(dbType)){
     * //postgres日期函数 dateFunction = "'"+dateStr+"'::date "; }else{ dateFunction = dateStr; } return
     * dateFunction; }
     */
     ...
     */
    /*
     * public static String getDBType(){ return DBTypeUtil.getDBType(); }
     */
}
